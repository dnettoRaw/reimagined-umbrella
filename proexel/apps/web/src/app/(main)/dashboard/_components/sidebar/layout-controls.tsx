  ...
  return (
    <Popover>
      <PopoverTrigger asChild>
        <Button size="icon" aria-label={t("preferences.open")}>
          <Settings />
        </Button>
      </PopoverTrigger>
      <PopoverContent align="end">
        <div className="flex flex-col gap-5">
          ...
          <div className="space-y-3 **:data-[slot=toggle-group]:w-full **:data-[slot=toggle-group-item]:flex-1 **:data-[slot=toggle-group-item]:text-xs">
            <div className="space-y-1">
              ...
              <Select value={themePreset} onValueChange={onThemePresetChange}>
                <SelectTrigger size="sm" className="w-full text-xs">
                  <SelectValue placeholder={t("preferences.preset")} />
                </SelectTrigger>
                <SelectContent>
                  <SelectGroup>
                    {THEME_PRESET_OPTIONS.map((preset) => (
                      <SelectItem key={preset.value} className="text-xs" value={preset.value}>
                        ...
                        />
                        {preset.value === "default" ? t("preferences.default") : preset.label}
                      </SelectItem>
                    ))}
                  </SelectGroup>
                </SelectContent>
            ...
            <div className="space-y-1">
              <Label className="font-medium text-xs">{t("preferences.collapseMode")}</Label>
              <ToggleGroup
                size="sm"
                variant="outline"
                type="single"
