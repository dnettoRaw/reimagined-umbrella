...
| 05 Auth/RBAC/audit | 100% | Scrypt, signed sessions, four-role enforcement in Next and Rust, semantic audit and rejection policy |
...
| 11 Release | Unit/integration/E2E, volume/concurrency, lint/type/build and dependency audits | Full disk/network/read-only/sync fault injection and production identity evidence remain external/open |

## Verified gates

- Rust workspace: 25 tests, including domain boundaries, storage, migration,
